...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="auto-style1 display">
                <asp:GridView ID="dgvTheatre" runat="server" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="12" ForeColor="Black" GridLines="Horizontal" Width="500px" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True">
