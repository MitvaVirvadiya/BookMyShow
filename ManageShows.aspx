...
<body>
    ...
    <div class="display">
        <asp:GridView ID="dgvShows" runat="server" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="12" ForeColor="Black" GridLines="Horizontal" Width="727px" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" OnSelectedIndexChanged="dgvShows_SelectedIndexChanged" >
