...
<body>
      ...
      <div class="form">
        ...
        <div class="form-group">
          ...
          <asp:TextBox ID="movieNameTxt" class="input" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="movieNameTxt" CssClass="error" ErrorMessage="Movie name is required"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
          ...
          <asp:TextBox ID="descriptionTxt" class="input" runat="server" TextMode="MultiLine"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="descriptionTxt" CssClass="error" ErrorMessage="Description is required"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
          ...
          <asp:TextBox ID="releaseDateTxt" class="input" runat="server" TextMode="Date"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="releaseDateTxt" CssClass="error" ErrorMessage="Release date is required"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
          <asp:Label ID="imageLB" runat="server" class="label" Text="Image:"></asp:Label>
          <asp:FileUpload ID="imageUpload" runat="server" />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="imageUpload" CssClass="error" ErrorMessage="image is required"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
          ...
          <asp:TextBox ID="durationTxt" class="input" runat="server" TextMode="Number"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="durationTxt" CssClass="error" ErrorMessage="Duration is required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="genreRadioList" CssClass="error" ErrorMessage="Genre is required"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="languageRadioList" CssClass="error" ErrorMessage="Language is required">Language is required</asp:RequiredFieldValidator>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ratingRadioList" CssClass="error" ErrorMessage="Rating is required"></asp:RequiredFieldValidator>
        </div>
    ...
    <div class="display">
        <asp:GridView ID="dgvMovies" runat="server" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="12" ForeColor="Black" GridLines="Horizontal" Width="727px" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" OnRowDeleting="dgvMovies_RowDeleting" OnSelectedIndexChanged="dgvMovies_SelectedIndexChanged" >
            <Columns>
